...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="assets/css/thongke.css" rel="stylesheet">
    ...
    <body class="antialiased">
        <div class="main-content">
            <h2>Thống kê hoạt động xuất kho</h2>
            <h3>Chọn hình thức thống kê</h3>
            <form method="post" action="{{ url('ket_qua_xuat_kho') }}">
                {{ csrf_field()}}
